...
const socials = [
  { icon: <FaLinkedin />, path: "https://www.linkedin.com/in/utsav-bhoraniya-b83aba3b0?utm_source=share_via&utm_content=profile&utm_medium=member_android" },
  { icon: <FaGithub />, path: "https://github.com/utsav8196-del" },
